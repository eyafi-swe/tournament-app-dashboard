...
const SignIn: React.FC = () => {
  ...
  const { setLoginToken, setLoading } = useContext(AuthContext);
    ...
    fetch(BASE_URL + '/admin/login', {
      ...
      .then((data) => {
        if (data.success) {
          console.log(data);
          console.log(data);
          setLoginToken({ ul_token: data.user_token });
          localStorage.setItem('ul_token', data.user_token);
          navigate(from);
        } else {
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Login to start</span>
