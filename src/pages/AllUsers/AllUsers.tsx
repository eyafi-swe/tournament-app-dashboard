    ...
    const fetchUsers = async () => {
      ...
      try {
        const response = await fetch(
          `${BASE_URL}/users?page=${currentPage}&limit=100&email=${search}&range=${range}&wallet=${walletSearch}`,
        );
    ...
    <DefaultLayout>
      ...
      <div className="mb-5 flex-col md:flex-row flex items-center w-full gap-5 ">
        <div className="w-full md:w-2/3 flex items-center">
          ...
          <button className="btn btn-warning" onClick={handleSearchInput}>
            Search
          </button>
        </div>
        <div className="w-full md:w-1/3 flex items-center">
          ...
          <button className="btn btn-warning" onClick={handleWalletSearchInput}>
            Search
          </button>
        </div>
      </div>
      ...
      <div className="my-5 flex items-center flex-wrap gap-10">
        <div className="flex items-center gap-3 mt-1">
          ...
          />
          <label className="text-lg font-semibold text-sky-500">
            0-100 BDT
          </label>
        </div>
        <div className="flex items-center gap-3 mt-1">
