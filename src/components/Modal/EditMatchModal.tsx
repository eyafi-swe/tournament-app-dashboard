...
const EditMatchModal: React.FC<EditMatchModalProps> = ({
  ...
  const handleEditMatch = (e: any) => {
    ...
    let rules = [];
    if (form.rule1.value !== '') {
      rules.push(form.rule1.value);
    }
    if (form.rule2.value !== '') {
      rules.push(form.rule2.value);
    }
    if (form.rule3.value !== '') {
      rules.push(form.rule3.value);
    }
    if (form.rule4.value !== '') {
      rules.push(form.rule4.value);
    }
    if (form.rule5.value !== '') {
      rules.push(form.rule5.value);
    }
    let data = {
        ...
        <div className="modal-box bg-white">
          ...
          <form onSubmit={handleEditMatch}>
            ...
            <input
              type="text"
              required
              defaultValue={matchInfo.joinFee}
              name="joinFee"
              placeholder="Type here"
              className="input input-sm focus:outline-none mt-1 input-bordered bg-slate-100 w-full "
            />
            ...
            <select
              name="type"
              className="select bg-slate-100 w-full select-sm focus:outline-none"
            >
              <option selected value={matchInfo.type}>
                {matchInfo.type?.toUpperCase()}
              </option>

              {getMatchTypes().map((type, index) => (
                <option value={type} key={index} className="text-black">
                  {type?.toUpperCase()}
                </option>
              ))}
            </select>
            ...
            <input
              type="text"
              required
              defaultValue={matchInfo.per_kill}
              name="perkill"
              placeholder="Type here"
              className="input input-sm focus:outline-none mt-1 input-bordered bg-slate-100 w-full "
            />
            ...
            <input
              type="text"
              required
              defaultValue={matchInfo.passcode}
              name="passcode"
              placeholder="Type here"
              className="input input-sm focus:outline-none mt-1 input-bordered bg-slate-100 w-full "
            />
            ...
            <input
              ...
              required
              defaultValue={
                matchInfo?.prize_pole ? matchInfo?.prize_pole[0]?.prize : ''
              }
              name="winner"
              placeholder="Type here"
              className="input input-sm focus:outline-none mt-1 input-bordered bg-slate-100 w-full "
            ...
            <input
              ...
              required
              defaultValue={
                matchInfo?.prize_pole ? matchInfo?.prize_pole[1]?.prize : ''
              }
              name="secondplace"
              placeholder="Type here"
              className="input input-sm focus:outline-none mt-1 input-bordered bg-slate-100 w-full "
            ...
            <input
              ...
              required
              defaultValue={
                matchInfo?.prize_pole ? matchInfo?.prize_pole[2]?.prize : ''
              }
              name="thirdplace"
              placeholder="Type here"
              className="input input-sm focus:outline-none mt-1 input-bordered bg-slate-100 w-full "
            ...
            <input
              ...
              required
              defaultValue={
                matchInfo?.prize_pole ? matchInfo?.prize_pole[3]?.prize : ''
              }
              name="fourthplace"
              placeholder="Type here"
              className="input input-sm focus:outline-none mt-1 input-bordered bg-slate-100 w-full "
            ...
            <input
              ...
              required
              defaultValue={
                matchInfo?.prize_pole ? matchInfo?.prize_pole[4]?.prize : ''
              }
              name="fifthplace"
              placeholder="Type here"
              className="input input-sm focus:outline-none mt-1 input-bordered bg-slate-100 w-full "
            ...
            <input
              ...
              required
              defaultValue={
                matchInfo?.prize_pole ? matchInfo?.prize_pole[5]?.prize : ''
              }
              name="perkillwinner"
              placeholder="Type here"
              className="input input-sm focus:outline-none mt-1 input-bordered bg-slate-100 w-full "
            ...
            <input
              ...
              required
              defaultValue={
                matchInfo?.prize_pole ? matchInfo?.prize_pole[6]?.prize : ''
              }
              name="total"
              placeholder="Type here"
              className="input input-sm focus:outline-none mt-1 input-bordered bg-slate-100 w-full "
            ...
            <h3 className="font-semibold text-center mt-2">Rules</h3>

            <h3 className="font-semibold">Rule 1</h3>
            <input
              type="text"
              name="rule1"
              defaultValue={matchInfo?.rules ? matchInfo?.rules[0] : ''}
              placeholder="Type here"
              className="input input-sm focus:outline-none mt-1 input-bordered bg-slate-200 w-full "
            />
            <h3 className="font-semibold">Rule 2</h3>
            <input
              type="text"
              name="rule2"
              defaultValue={matchInfo?.rules ? matchInfo?.rules[1] : ''}
              placeholder="Type here"
              className="input input-sm focus:outline-none mt-1 input-bordered bg-slate-200 w-full "
            />
            ...
            <input
              type="text"
              name="rule3"
              defaultValue={matchInfo?.rules ? matchInfo?.rules[2] : ''}
              placeholder="Type here"
              className="input input-sm focus:outline-none mt-1 input-bordered bg-slate-200 w-full "
            />
            <h3 className="font-semibold">Rule 4</h3>
            <input
              type="text"
              name="rule4"
              defaultValue={matchInfo?.rules ? matchInfo?.rules[3] : ''}
              placeholder="Type here"
              className="input input-sm focus:outline-none mt-1 input-bordered bg-slate-200 w-full "
            />
            <h3 className="font-semibold">Rule 5</h3>
            <input
              type="text"
              name="rule5"
              defaultValue={matchInfo?.rules ? matchInfo?.rules[3] : ''}
            ...
            <button
              className={`btn btn-md text-white btn-accent mt-5 w-full ${
